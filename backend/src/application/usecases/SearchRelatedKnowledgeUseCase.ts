...
export class SearchRelatedKnowledgeUseCase {
    ...
    async execute(
        ...
        try {
            ...
            const topicEmbedding = await this.vertexAIService.generateEmbedding(trimmedText);
            ...
            for (const knowledge of allKnowledge) {
                try {
                    ...
                    const knowledgeEmbedding = await this.vertexAIService.generateEmbedding(
                        knowledgeText
                    );
                    ...
                    if (relevanceScore >= threshold * 100) {
